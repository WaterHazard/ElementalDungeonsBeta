package com.lebroskis.elementaldungeons.container;
...
public class PurifierContainer extends Container{
    ...
    public PurifierContainer(int windowid, World world, BlockPos pos,
        ...
        if(tileEntity != null){
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                addSlot(new SlotItemHandler(h, 1, 52, 13));
                addSlot(new SlotItemHandler(h, 0, 108, 13));
      ...
      public int getCounter(){
          return ((PurifierTile)this.tileEntity).getCounter();
    }

    public boolean canCraft(){
        return ((PurifierTile) this.tileEntity).canCraft();
    }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        ...
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, modblocks.PURIFIER.get());
    }
